              ...
              >
                ...
                {#if snip.content_markdown}
                  ...
                  <div class="flex items-start gap-2">
                    <div class="prose prose-sm max-w-none text-lg whitespace-pre-wrap dark:prose-invert flex-1 min-w-0 break-words">
...
<button
            ...
            >
              {#if item.snipsel.content_markdown}
                  ...
                  <div class="flex items-start gap-2">
                    <div
                      class="prose prose-sm max-w-none text-lg prose-headings:my-2 prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg whitespace-pre-wrap dark:prose-invert flex-1 min-w-0 break-words"
